      ...
      <Card className="border border-border bg-white text-gray-900 shadow-sm">
        <CardContent className="p-6 space-y-6">
          ...
          <div className="rounded-md border border-red-200 bg-red-50 text-sm text-gray-700 px-4 py-3 text-center">
            <span className="text-red-600">Nombre</span> | Precio sin impuesto | Impuesto en % | Precio con impuesto | Unidad de medida | Stock | Marca | Modelo | Código | Proveedor | Costo de compra | Descripción | Stock mínimo | Recargo en % | ID Categoría
          </div>
        </CardContent>
      </Card>
